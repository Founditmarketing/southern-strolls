        ...
        {submitted ? (
          ...
          >
            ...
            <p className="text-slate/80 font-light text-lg">
              Our concierge team will contact you within 24 hours to schedule your mandatory meet and greet ($15 fee).
            </p>
          </motion.div>
        ) : (
          <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-12">
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <label htmlFor="policy-ack" className="text-sm text-slate/80 font-light leading-relaxed cursor-pointer">
                I understand that services are only available in <strong className="font-medium text-slate">Youngsville, Lafayette, Broussard, and Scott</strong>, and a mandatory $15 Meet & Greet is required before services begin.
              </label>
            </div>
