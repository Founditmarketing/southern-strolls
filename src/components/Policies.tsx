import { Clock, ShieldCheck, MapPin, Key, XCircle, Sparkles } from 'lucide-react';
...
const policies = [
    ...
    {
        icon: ShieldCheck,
        title: "Mandatory Meet & Greet",
        desc: "A $15 Meet & Greet is required before services begin. This allows us to meet your pet, learn routines, review home access, and ensure a safe, perfect fit for everyone."
    },
    {
        icon: Clock,
