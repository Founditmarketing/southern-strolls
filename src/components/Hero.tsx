...
export function Hero() {
  return (
    <section className="relative min-h-[95vh] flex items-center pt-40 pb-20 md:pt-20 md:pb-0 overflow-hidden bg-cream">
        ...
        <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-center text-center lg:text-left">
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start">
            ...
            >
              ...
              <h1 className="text-6xl sm:text-7xl lg:text-8xl font-serif leading-[0.95] tracking-tight mb-6 sm:mb-8 text-slate relative z-20">
                Southern <br />
                <span className="italic text-mint">Strolls</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4 sm:gap-6 mt-6 sm:mt-8 mb-8 sm:mb-0 relative z-20">
                <a href="https://www.timetopet.com/portal/southernstrolls/create-account" target="_blank" rel="noopener noreferrer" className="bg-mint text-slate px-8 py-4 rounded-full text-sm tracking-widest uppercase hover:bg-blush hover:text-white transition-colors duration-300 w-full sm:w-auto text-center font-medium shadow-md">
          ...
          <div className="lg:col-span-5 relative mt-12 md:mt-0 h-[450px] sm:h-[550px] md:h-[700px] w-full max-w-md sm:max-w-lg mx-auto md:max-w-none">
            ...
            <motion.div
              ...
              className="absolute right-0 top-16 md:top-8 w-[85%] h-[80%] md:w-4/5 md:h-[90%] z-10"
            >
              <img
